...
cust_info = 'cust_id'+'='+str(cust_id)+',cust_name'+'='+cust_name+',cust_dob'+'='+'00000000'+',cust_status_code'+'='+str(cust_status_code)+',cust_gender'+'='+ cust_gender
...
try:
	...
	if ( int(r.status_code) == 100):
		...
		if (word.find('Could not enter data') != -1):
			print ("Test CAS_005 FAILED ")
		else:
			print ("Test CAS_005 PASSED")
